          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                num: '06',
                titulo: 'Sus derechos',
                texto: 'Conforme a la Ley N° 29733, usted tiene derecho a acceder, rectificar, cancelar u oponerse al tratamiento de sus datos personales. Para ejercer estos derechos, contáctenos a hoteles@adventur.pe o al +51 958 101 721.',
              },
              {
                num: '07',
                titulo: 'Seguridad',
