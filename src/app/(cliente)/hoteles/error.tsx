...
export default function ErrorHoteles({ reset }: { error: Error; reset: () => void }) {
  return (
    <div className="flex-1 flex items-center justify-center py-20 px-6 bg-(--bg-subtle) min-h-[60vh]">
      <div className="text-center bg-white border border-gray-100 rounded-3xl shadow-lg p-10 max-w-md w-full">
        ...
        <h2 className="text-xl sm:text-2xl font-black text-(--brand-navy) mb-3 tracking-tight">
