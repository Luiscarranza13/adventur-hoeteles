    ...
    <>
      ...
      <main className="bg-[var(--bg-subtle)] py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto">
          <div className="bg-[var(--brand-navy)]/5 border border-[var(--brand-navy)]/10 rounded-2xl p-5 sm:p-6 mb-6">
            <p className="text-xs text-gray-600 leading-relaxed">
              La formulación del reclamo no impide acudir a otras vías de solución de controversias ni es requisito previo para interponer una denuncia ante el INDECOPI. El proveedor debe dar respuesta al reclamo en un plazo no mayor a <strong className="text-[var(--brand-navy)]">30 días calendario</strong>.
            </p>
          </div>
