...
export default function GlobalError({
  ...
  return (
    <main style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1.5rem', background: '#f8fafc' }}>
      <section style={{
        maxWidth: '420px',
        width: '100%',
        textAlign: 'center',
        ...
        <p style={{ fontSize: '0.875rem', color: '#64748b', lineHeight: 1.6, marginBottom: '1.5rem' }}>
          La aplicacion encontro un problema inesperado. Intenta recargar esta vista.
        </p>
        {error.digest && (
